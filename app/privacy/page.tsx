...
import { legalUpdatedAt, privacySectionIds } from "@/data/content";
...
export const metadata: Metadata = buildMetadata({
  path: "/privacy",
  ...getDictionary("en").meta.pages.privacy,
});
  ...
  return (
    <>
      ...
      <Container width="narrow" className="py-16 sm:py-20">
        ...
        <SectionList
          items={privacySectionIds.map((id) => dict.legal.privacy.sections[id])}
        />
      </Container>
    </>
  );
